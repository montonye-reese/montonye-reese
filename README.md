...
Three prompts center the LLM before it contemplates substrate needs of multiple gauntlet [voices](https://github.com/montonye-reese/gauntlet/blob/main/voices/voices.html)
